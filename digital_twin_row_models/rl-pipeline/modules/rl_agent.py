...
# 중앙 모델 폴더 우선 (Digital_twin/model/avoidance-route/models), 없으면 로컬 폴백
_CENTRAL_BASE = Path(__file__).resolve().parents[3] / "Digital_twin" / "model" / "avoidance-route" / "models"
